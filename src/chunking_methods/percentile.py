...
class PercentileChunker:
    ...
    def __init__(self, embeddings: HuggingFaceEmbeddings):
        ...
        self.base_dir = Path("chunks/percentile")
        ...
        print(f"Percentile directory structure created/verified: {self.base_dir}")
        self.process_counter = 0
    
    def split_text(self, text: str, source: str = None, file_name: str = None) -> List[str]:
        """
        Split text into chunks using percentile-based approach.
        
        Args:
            text (str): Text to split
            source (str): Source of the text (e.g., 'pubmed', 'arxiv', 'history', 'legal', 'ecommerce')
